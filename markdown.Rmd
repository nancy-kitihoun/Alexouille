...
data2=readRDS(file='C:/Users/Hp/Documents/GitHub/Application/genre/creditcard.rds')
names(data2)
```
...
*On peut conclure que la technique....*
...
*De plus il n'est pas aussi performent que...*
